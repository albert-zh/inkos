...
Open-source CLI agent that autonomously writes, audits, and revises novels — with human review gates that keep you in control. Supports LitRPG, Progression Fantasy, Isekai, Romantasy, Sci-Fi, Horror, Xuanhuan, Xianxia, Urban, and more. Continuation, spinoff, fanfic, and style imitation workflows built in.
